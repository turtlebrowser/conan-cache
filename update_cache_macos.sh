...
export CONAN_USER_HOME="/Users/patriciaaas/Code/conan-cache-turtlebrowser"
...
confirm "Clean cache? [y/N]" && cd ${CONAN_USER_HOME} && git clean -df && git checkout . && git checkout host-macOS-target-macOS-macos-11.0-master
